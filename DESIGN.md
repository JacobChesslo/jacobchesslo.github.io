...
> *"The rigor of science meets the messiness of discovery, with the energy of a DJ set."*
...
### Google Fonts Import
```html
<link href="https://fonts.googleapis.com/css2?family=Syne:wght@600;700;800&family=Outfit:wght@300;400;500&family=JetBrains+Mono:ital,wght@0,300;0,400;0,500;1,300&display=swap" rel="stylesheet">
```
...
*This is the living design contract for jacobchesslo.com. Update as decisions solidify. Lock before dev handoff.*
